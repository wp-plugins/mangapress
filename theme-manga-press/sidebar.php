...
<a href="<?php bloginfo('rss2_url')?>" rel="rss bookmark" title="Subscribe to news-feed!" class="subscribe-link"><img src="<?php bloginfo('template_url') ?>/images/feed.png" class="feed-icon" alt="Subscribe!" /> Subscribe to RSS for news and updates!</a><br />
