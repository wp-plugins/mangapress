...
<?php get_header(); ?>
	...
	<?php if (is_comic_page()):?>
        ...
        <!--Last Update: <?=date('d/m/Y', strtotime($post_date)); ?> -->
            ...
            <div <?php post_class('the-post'); ?> id="post-<?php the_ID()?>">          
                <h2 style="text-align: center;"><?php the_title() ?>: <?=$post_title?></h2>
                <span class="post-meta">This is a demo of Manga+Press's comic navigation abilities. I'm using pages
                from my webcomic <a href="http://www.silent-shadow.net" rel="me" title="Silent Shadow: updated irregularly but come visit anyway!"><em>Silent Shadow</em></a> as an example.</span>
                <div class="the-content" style="text-align: center;">
                	<?php 
						/**
